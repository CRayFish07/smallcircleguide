# -*- coding: utf-8 -*-
#
# SmallCircle documentation build configuration file, created by
...
project = u'SmallCircle'
copyright = u'2014 - 2015, 无穷大软件'
...
html_title = u'小圈子(SmallCircle) 1.0.0 中文手册|用户手册|用户指南|中文文档'
...
htmlhelp_basename = 'SmallCircledoc'
...
latex_documents = [
  ('index', 'SmallCircle.tex', u'SmallCircle 中文手册',
   ur'\hfill 无穷大软件\\SmallCircle 中国开发者社区', 'manual'),
]
...
man_pages = [
    ('index', 'smallcircle', u'SmallCircle 文档',
     [u'无穷大软件'], 1)
]
...
epub_title = u'SmallCircle'
epub_author = u'无穷大软件'
epub_publisher = u'无穷大软件'
epub_copyright = u'2014 - 2015, 无穷大软件'
