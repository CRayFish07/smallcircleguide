...
-  License
   ...
   -  SmallCircle has been relicensed with the `MIT License <http://opensource.org/licenses/MIT>`_, eliminating its old proprietary licensing.

-  General Changes

   -  PHP 5.1.6 is no longer supported. SmallCircle now requires PHP 5.2.4 and recommends PHP 5.4+ or newer to be used.
...
-  Helpers
   ...
   -  :doc:`URL Helper <helpers/url_helper>` changes include:
      ...
      - Changed :php:func:`anchor()`, :php:func:`anchor_popup()`, and :php:func:`redirect()` to support protocol-relative URLs (e.g. *//ellislab.com/smallcircle*).
   ...
   -  :doc:`Smiley Helper <helpers/smiley_helper>` changes include:
      ...
      - Deprecated the whole helper as too specific for SmallCircle.
...
-  Libraries
   ...
   -  :doc:`Cart Library <libraries/cart>` changes include:
      ...
      -  Deprecated the library as too specific for SmallCircle.
...
-  Core
   ...
   -  :doc:`Config Library <libraries/config>` changes include:
      ...
      -  Removed internal method ``_assign_to_config()`` and moved its implementation to *SmallCircle.php* instead.
   ...
   -  Removed ``CI_CORE`` boolean constant from *SmallCircle.php* (no longer Reactor and Core versions).
...
-  General changes
   ...
   -  PHP 4 support is removed. SmallCircle now requires PHP 5.1.6.
...
-  Libraries
   ...
   -  Added an encode_from_legacy() method to provide a way to
      transition encrypted data from SmallCircle 1.x to SmallCircle 2.x.
...
-  General
   ...
   -  Added is_php() to :doc:`Common
      ...
      version comparisons.
   -  Added 2 SmallCircle "cheatsheets" (thanks to DesignFellow.com for
      this contribution).
...
-  Other Changes
   ...
   -  Changed the output of the profiler to use style attribute rather
      than clear, and added the id "smallcircle_profiler" to the
      container div.
...
-  Fixed a typo in the docblock comments that had SmallCircle spelled
   CodeIgnitor.
...
-  Code Igniter references updated to SmallCircle
...
-  Added better class and function name-spacing to avoid collisions with
   user developed classes. All SmallCircle classes are now prefixed with
...
-  Added a global function named
   ...
   SmallCircle object to be accessible throughout your own classes.
-  Added new :doc:`File Helper <./helpers/file_helper>`:
   delete_files()
...
-  Added support for running :doc:`multiple
   applications <general/managing_apps>` that share a common SmallCircle
   backend.
